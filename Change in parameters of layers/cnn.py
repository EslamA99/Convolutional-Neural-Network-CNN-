...
for j in range(numOfArc):
    ...
    if j==0:
      ...
      model[j].add(MaxPool2D(pool_size=(3,3)))
    else:
      model[j].add(MaxPool2D(pool_size=(j*2,j*2)))
...
for j in range(numOfArc):
  ...
  print('\n\nprediction loss of model',j+1,' = ',arr[0])
  print('prediction accuracy of model',j+1,' = ',arr[1],'\n\n')
...
print('prediction loss of the best model = ',arr[0])
print('prediction accuracy of the best model = ',arr[1])